...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>TestLinkCOACustomerToLMALicense</apexClass>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Customer_Feedback__c.Case__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Customer_Feedback__c.Feedback__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Customer_Feedback__c.Happy_with_our_Customer__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Customer_Feedback__c.Recommend_us_to_others__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Customer_Feedback__c.Score__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <flowAccesses>
        <enabled>false</enabled>
        <flow>customer_satisfaction_1</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
    ...
    <tabVisibilities>
        <tab>sfcma__PaymentIntent__c</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
    <tabVisibilities>
    ...
    <tabVisibilities>
        <tab>standard-RecordAlertActionableTarget</tab>
        <visibility>DefaultOn</visibility>
    </tabVisibilities>
    <tabVisibilities>
